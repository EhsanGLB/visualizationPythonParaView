# visualizationPythonParaView
This is a combination code to visualize different fields and contours written based on python 3 and foam-extend-4.1.


## Installation
It is working on foam-extend-4.1
```bash
git clone https://github.com/EhsanGLB/visualizationPythonParaView.git
```


## Getting Started
```bash
cd visualizationPythonParaView/visualizationPythonParaView/case
./Allrun
cd ../
python paraViewPP.py
```
